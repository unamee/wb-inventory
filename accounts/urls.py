...
urlpatterns = [
    ...
    path('user/purchase-request/create/update-item/', views.updateItem, name='update_item'),
    path('user/purchase-request/create/process_order/', views.processOrder, name='process_order'),
